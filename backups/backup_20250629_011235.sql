...
CREATE TABLE `入库记录` (
  ...
  PRIMARY KEY (`入库ID`),
  KEY `药品ID` (`药品ID`),
  KEY `idx_入库记录_药品ID_入库时间` (`药品ID`,`入库时间`),
...
CREATE TABLE `处方明细` (
  ...
  KEY `处方ID` (`处方ID`),
  KEY `药品ID` (`药品ID`),
  KEY `idx_处方明细_处方ID_药品ID` (`处方ID`,`药品ID`),
...
CREATE TABLE `收费记录` (
  ...
  PRIMARY KEY (`收费ID`),
  KEY `处方ID` (`处方ID`),
  KEY `idx_收费记录_处方ID_收费时间` (`处方ID`,`收费时间` DESC),
...
REPLACE INTO `收费记录` VALUES (2,2,30.40,'2025-05-10 10:05:00','张财务','支付宝'),(3,3,68.00,'2025-05-12 14:40:00','李出纳','微信支付'),(4,4,43.30,'2025-05-15 12:00:00','张财务','医保卡'),(5,5,61.80,'2025-05-20 10:30:00','王收银','现金'),(6,6,45.60,'2025-06-01 09:20:00','李出纳','微信支付'),(7,7,25.00,'2025-06-03 17:00:00','张财务','医保卡'),(8,7,25.80,'2025-06-06 20:38:00','zyf','现金'),(9,7,12.50,'2025-06-18 14:50:00','zyf','医保卡');
...
-- Dump completed on 2025-06-29  1:12:36
