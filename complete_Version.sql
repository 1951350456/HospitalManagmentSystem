...
INSERT INTO `users` VALUES (3,'zyf','5fd8ecec630074686df4be84705fc8c1f3f97b9ad35ab0db9dbe8656b7be5f0a');
...
INSERT INTO `入库记录` VALUES (8,10,100,'2025-04-01 10:00:00','库管员A','华北制药'),(9,11,150,'2025-04-05 14:30:00','库管员B','上海信谊'),(10,12,50,'2025-04-10 09:15:00','库管员A','阿斯利康'),(11,13,30,'2025-04-15 11:20:00','库管员C','强生制药'),(12,14,80,'2025-04-20 16:45:00','库管员B','养生堂'),(13,10,50,'2025-05-25 13:10:00','库管员A','广州白云山');
...
INSERT INTO `出库记录` VALUES (1,10,20,'2025-05-05 10:30:00','库管员B',2),(2,11,30,'2025-05-08 14:00:00','库管员A',3),(3,12,15,'2025-05-12 09:45:00','库管员C',4),(4,13,25,'2025-05-18 11:20:00','库管员B',5),(5,14,10,'2025-05-22 16:10:00','库管员A',6),(6,13,30,'2025-06-06 00:00:00','zyf',5);
...
INSERT INTO `医生` VALUES (2,'张明远','男','主任医师',2,'13800138001','2010-05-20'),(3,'李思雨','女','副主任医师',3,'13900139002','2015-08-15'),(4,'王建国','男','主治医师',4,'13700137003','2018-03-10'),(5,'赵晓雯','女','主任医师',5,'13600136004','2008-11-30'),(6,'刘振华','男','副主任医师',6,'13500135005','2016-07-22');
...
INSERT INTO `处方` VALUES (2,2,2,'2025-05-10 09:30:00','高血压二级'),(3,3,3,'2025-05-12 14:15:00','慢性胃炎'),(4,4,4,'2025-05-15 11:20:00','急性肠胃炎'),(5,5,5,'2025-05-20 10:00:00','儿童上呼吸道感染'),(6,2,2,'2025-06-01 08:45:00','高血压复诊'),(7,6,6,'2025-06-03 16:30:00','腰椎间盘突出');
...
INSERT INTO `处方明细` VALUES (1,2,11,2,'每日一次，每次1片'),(2,3,12,1,'每日一次，每次1粒'),(3,4,10,1,'每日三次，每次2粒'),(4,4,13,1,'疼痛时服用，每次1片'),(5,5,14,1,'每日一次，每次1片'),(6,5,10,1,'每日三次，每次1粒'),(7,6,11,3,'每日一次，每次1片'),(8,7,13,2,'每日两次，每次1片'),(9,7,10,1,'每日两次，每次1片'),(10,7,13,1,'每日两次，每次1片');
...
INSERT INTO `库存预警` VALUES (2,13,'药品库存低于安全水平: 布洛芬','2025-06-06 16:13:59');
...
INSERT INTO `收费记录` VALUES (2,2,30.40,'2025-05-10 10:05:00','张财务','支付宝'),(3,3,68.00,'2025-05-12 14:40:00','李出纳','微信支付'),(4,4,43.30,'2025-05-15 12:00:00','张财务','医保卡'),(5,5,61.80,'2025-05-20 10:30:00','王收银','现金'),(6,6,45.60,'2025-06-01 09:20:00','李出纳','微信支付'),(7,7,25.00,'2025-06-03 17:00:00','张财务','医保卡'),(8,7,25.80,'2025-06-06 20:38:00','zyf','现金');
...
INSERT INTO `未缴费处方` VALUES (7,'刘伟强','刘振华','2025-06-03 16:30:00','腰椎间盘突出',12.50);
...
INSERT INTO `病人` VALUES (2,'陈晓东','男','1985-07-12','18611112222','北京市朝阳区建国路88号','YB110225198507123456'),(3,'李静怡','女','1992-03-25','18733334444','上海市浦东新区张江路56号','YB310115199203255678'),(4,'王思聪','男','1978-11-08','18855556666','广州市天河区体育西路120号','YB440106197811084321'),(5,'赵欣然','女','2005-09-17','18977778888','深圳市南山区科技园南路18号','YB440305200509170987'),(6,'刘伟强','男','1965-02-28','18299990000','成都市武侯区人民南路四段88号','YB510107196502281234');
...
INSERT INTO `科室` VALUES (2,'心血管内科','张明远','心脏及血管疾病诊疗'),(3,'消化内科','李思雨','胃肠道疾病诊疗'),(4,'急诊科','王建国','24小时急诊服务'),(5,'儿科','赵晓雯','儿童疾病诊疗'),(6,'骨科','刘振华','骨骼系统疾病诊疗');
...
INSERT INTO `药品信息` VALUES (10,'阿莫西林',9,'0.5g*24粒','盒','华北制药',25.80,180),(11,'硝苯地平',10,'10mg*30片','瓶','上海信谊',15.20,220),(12,'奥美拉唑',11,'20mg*14粒','盒','阿斯利康',68.00,65),(13,'布洛芬',12,'0.3g*20片','盒','强生制药',12.50,5),(14,'维生素C',13,'100mg*60片','瓶','养生堂',26.00,110),(15,'头孢克肟',9,'0.1g*12片','盒','广州白云山',35.00,15);
...
INSERT INTO `药品类型` VALUES (9,'抗生素','用于治疗细菌感染的药物'),(10,'心血管','治疗心脏和血管疾病的药物'),(11,'消化系统','治疗胃肠道疾病的药物'),(12,'止痛药','缓解疼痛的药物'),(13,'维生素','补充人体所需维生素');
...
-- Dump completed on 2025-06-11 23:42:02
